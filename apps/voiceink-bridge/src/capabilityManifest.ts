...
const QUERY_METADATA: ReadonlyArray<QueryCapability> = [
  ...
  { query: ORCHESTRATION_WS_METHODS.getTurnDiff, availability: "planned", transport: "http" },
  { query: ORCHESTRATION_WS_METHODS.searchThreads, availability: "planned", transport: "http" },
  {
